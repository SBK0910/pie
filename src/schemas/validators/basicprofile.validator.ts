...
export const basicFinancialProfile = z.object({
    yearlySavings: z.number().min(0, "Yearly savings must be non-negative"),
    debt: z.number().min(0, "Debt must be non-negative"),
...
export const basicProfileSchema = basicFinancialProfile.merge(basicRiskProfile);
